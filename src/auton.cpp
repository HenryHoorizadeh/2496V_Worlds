  ...
  */
  ...
  for(int i = 0; i <= 30000; i+=10){
   ...
   // LBMacro = 4;
    ...
    LadyBrown.move(0);
    //LBMacro = 4;
    driveClamp(-1075, 150, 60);//1550
    LadyBrown.move(127);

    driveTurn2(72);
    stallProtection = true;
    color = 2;
    driveStraightI(1550, 100, 1500);
    intake.set_value(true);
    driveStraight2(800);
    intake.set_value(false);
    driveStraight2(-100);
